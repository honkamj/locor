...
def local_least_squares_error(
    ...
    # least_squares_matrix = least_squares_matrix.at[..., source_product_indices_2, source_product_indices_1].set(
    #    source_product_avg
    # )
    ...
    weights = jsp.linalg.solve(least_squares_matrix, source_target_avg, assume_a="sym")
